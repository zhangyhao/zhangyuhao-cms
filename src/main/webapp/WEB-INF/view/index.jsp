	...
	<div class="row">
			...
			<div class="row justify-content-center" style="margin-top:20px">
				<nav aria-label="Page navigation example" >
					  <ul class="pagination ">
					    ...
					    <li class="page-item">
					      <a class="page-link" href="/index/index?page=${articlePage.pageNum-1}&$es={key}" aria-label="Previous">
					    ...
					    <c:forEach begin="1" end="${articlePage.pages}" varStatus="index">
					    	...
					    	<c:if test="${articlePage.pageNum==index.index}">
					  		...
					  		<!-- 非当前页码的处理 -->
							<c:if test="${articlePage.pageNum!=index.index}">
					    		<li class="page-item"><a class="page-link" href="/index/?page=${index.index}&es=${key}"> ${index.index}</a></li>
					  		</c:if>
					  
					    </c:forEach>
					    
					    <li class="page-item">
					      <a class="page-link" href="/index/?page=${articlePage.pageNum+1}&es=${key}">
		...
		<div class="col-md-4">
			  ...
			  <div class="card" style="margin-top:50px">
					  ...
					  <div class="card-body">
					     <ul>
					     <c:forEach items="${hot_list}" var="article" varStatus="index">
					     		<li class="ex"> ${index.index+1}. <a href="/article/detail?id=${article.id}" target="_blank" >${article.title}</a></li>
					     	</c:forEach>
					     </ul>
					  </div>
